...
const items = [
    {
      ...
      <div className='grid grid-cols-3'>
            <div className='h-[300px] bg-[#333]/[50%] mt-[20px] flex justify-center items-center'>
                <p className='text-center font-afacadFlux text-white select-none cursor-pointer'>Hello Fellow Twika Members</p>
            </div>
            <div className='h-[300px] bg-[radial-gradient(circle,_#3b82f6,_#ef4444)] mt-[20px] flex justify-center items-center'>
                <p className='text-center font-afacadFlux text-white select-none cursor-pointer'>Hello Fellow Twika Members</p>
            </div>
            <div className='h-[300px] bg-[radial-gradient(circle,_#3b44f6,_#ef9844)] mt-[20px] flex justify-center items-center'>
                <p className='text-center font-afacadFlux text-white select-none cursor-pointer'>Hello Fellow Twika Members</p>
            </div>
            <div className='h-[300px] bg-[radial-gradient(circle,_#3344f6,_#ef9044)] mt-[20px] flex justify-center items-center'>
                <p className='text-center font-afacadFlux text-white select-none cursor-pointer'>Hello Fellow Twika Members</p>
            </div>
      </div>,
    },
        ...
        <div className='ml-[200px] flex flex-row justify-center bg-[#000] flex-1'>
            <div className='w-[80%] pr-[40px] pl-[40px] pt-[40px] pb-[40px]'>
                <div className='flex flex-row items-center space-x-[30px] pb-[40px] border-b-[1px] border-[#333]/[50%] border-solid'>
                    <div onClick={showEditProfileImageModal} className='w-[100px] cursor-pointer h-[100px] bg-slate-500 rounded-full'>
                        <img src="/images/memo_32.png" className='w-full h-full object-cover object-center' alt="Profile" />
                    </div>
                    <div>
                        <p className='font-afacadFlux font-bold select-none cursor-pointer'>caleb_.kwizera</p>
                        <div className='mt-[10px] flex flex-row space-x-[15px]'>
                            ...
                            <p className='font-afacadFlux font-bold select-none cursor-pointer'>Joined: 2 Months ago</p>
                        </div>
