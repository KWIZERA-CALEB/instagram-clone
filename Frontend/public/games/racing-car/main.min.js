...
function r1() {
    ...
    o7(t, r4);
    var t = [5, 192, 25, 206, 296, 190, 302, 164, 298, 149, 296, 145, 292, 111, 289, 103, 294, 101, 294, 91, 297, 84, 263, 72, 208, 14, 167, 2, 66, 3, 45, 7, 8, 55, 5, 65, 7, 88, 2, 97, 1, 151];
    o7(t, "#a9fb78");
    var t = [25, 206, 296, 190, 302, 164, 298, 149, 296, 145, 292, 111, 289, 103, 294, 101, 294, 91, 297, 84, 17, 93, 22, 122, 20, 162, 20, 170, 2, 145, 3, 160, 6, 187];
    o7(t, "#4abf74");
...
function k2(t) {
    ...
    j6(t.p1.u6.x - f, t.p1.u6.y, t.p1.u6.x, t.p1.u6.y, t.p4.u6.x, t.p4.u6.y, t.p4.u6.x - c, t.p4.u6.y, h);
    j6(t.p2.u6.x, t.p2.u6.y, t.p2.u6.x + f, t.p2.u6.y, t.p3.u6.x + c, t.p3.u6.y, t.p3.u6.x, t.p3.u6.y, h);
    if (!n3) {
        var u = n9;
        if (t.index == 0) {
            u = q2
        }
        j6(t.p1.u6.x, t.p1.u6.y, t.p2.u6.x, t.p2.u6.y, t.p3.u6.x, t.p3.u6.y, t.p4.u6.x, t.p4.u6.y, u)
    }
    ...
    j6(r - o / 2, t.p1.u6.y, r + o / 2, t.p1.u6.y, e + l / 2, t.p3.u6.y, e - l / 2, t.p3.u6.y, c6);
...
function e0(t, i, a, r, e) {
    ...
    if (f < s)
        t6.drawImage(t.c, 0, v, s - f, c, l - 1, o, i - l, d)
}
    ...
    for (v = v0.l3 - 1; v > 0; v--) {
        ...
        for (f = 0; f < c.cars.length; f++) {
            ...
            if (u.index !== 0) {
                ...
                d = g4((c.p1.u6.x + c.p2.u6.x) / 2, (c.p3.u6.x + c.p4.u6.x) / 2, u.percent) + x * u.x * width / 2;
        ...
        for (f = 0; f < c.t1.length; f++) {
            o = c.t1[f];
            l = c.p1.u6.scale;
            d = c.p1.u6.x - c.p1.v8.x * c.p1.u6.scale * width / 2 + l * o.x * width / 2;
            p = c.p1.u6.y;
            l = o.s * l;
        ...
        if (c == a) {
            ...
            b = height / 2 - v0.depth / v0.t7 * g4(a.p1.v0.y, a.p3.v0.y, r) * height / 2;
            var q = b;
            if (cars[0].t9 > 0) {
            ...
            d = g4((a.p1.u6.x + a.p2.u6.x) / 2, (a.p3.u6.x + a.p4.u6.x) / 2, r) + x * cars[0].x * width / 2;
            var I = {
                v8: {
                    x: u1.x,
                    y: u1.y,
...
Car.prototype = {
    ...
    b6: function() {
        ...
        for (e = 0; e < n; e++) {
            ...
            var f = this.x + this.width / 2 + a * Math.cos(h - .05);
            var c = this.y + a * sin(h - .02);
            var u = this.x + this.width / 2 + a * Math.cos(h + .05);
            var o = this.y + a * sin(h + .02);
            var l = this.x + this.width / 2 + v * Math.cos(h - .05);
            var d = this.y + v * sin(h - .05);
            var p = this.x + this.width / 2 + v * Math.cos(h + .05);
            var x = this.y + v * sin(h + .05);
            var g = f + (l - f) * this.c7[e];
            var m = u + (p - u) * this.c7[e];
            var w = c + (d - c) * this.c7[e];
            var k = o + (x - o) * this.c7[e];
            var y = f + (l - f) * (this.c7[e] + .4);
            var b = u + (p - u) * (this.c7[e] + .4);
            var q = c + (d - c) * (this.c7[e] + .4);
            var z = o + (x - o) * (this.c7[e] + .4);
            var I = i - r * this.c7[e];
            var j = i - r * (this.c7[e] + .4);
            var T = [];
            T.push({
                v8: {
                    x: g,
    ...
    update: function(t) {
        ...
        this.u8 = 3.4;
        if (c < -this.width * .1 || u < -this.width * .1) {
            if (c + this.width * .1 < -r.r0 || u + this.width * .1 < -r.r0) {
                this.u8 = 9.5;
                d -= .6;
                p -= .2
            } else {
...
v2.prototype = {
    ...
    o3: function() {
        ...
        t.e9();
        t.drawMap();
        t.createRoadsideObjects(k1, .9, 10, 900, true)
    },
    o2: function() {
        n9 = "#3a3a3a";
        d4 = "#047804";
        ...
        t.e9();
        t.drawMap();
        t.createRoadsideObjects([e8], .3, 6, 1300, true)
    },
    n8: function() {
        n9 = "#3a3a3a";
        d4 = "#5a5a5a";
        ...
        t.e9();
        t.drawMap();
        t.createRoadsideObjects(c8, .95, 20, 3300, false);
    ...
    easeInOut: function(t, i, a) {
        return t + (i - t) * (-Math.cos(a * Math.PI) / 2 + .5)
    },
    ...
    d7: function(t, i) {
        this.t3(25, 50 * 1.5, 25, t * 6 * .96, i, t * 90)
    },
    h1: function(t) {
        this.t3(18, 50 * .8, 18, t * 8, 0, t * 90)
    },
        ...
        for (var t = 0; t < this.s1; t++) {
            ...
            if (i.index !== 0) {
                ...
                if (i.index < 8 && i.index > 3) {
                    i.r6 = c * .905 - r9() * (this.s1 - t - 1) * c / 55
                } else if (i.index > 12) {
                    i.r6 = c * .905 - (this.s1 - t - 1) * c / 65
                } else {
                    i.r6 = c * .905 - (this.s1 - t - 1) * c / 45
                }
                i.accel = c / 2;
                if (i.index < 4) {
                    i.c5 = false
...
function a0() {
    ...
    var e = 0;
    f7[e++] = 1;
    for (var s = .05; s < 1; s += Math.random() / 8 + .01) {
        r = Math.floor(s * t);
        a = Math.random() * 2 - 1;
        var n = r - (e - 1);
        var h = (a - i) / n;
...
function g8() {
    ...
    a.connect(s0.destination);
    r.buffer = n7;
    a.gain.linearRampToValueAtTime(.5, s0.currentTime);
    a.gain.linearRampToValueAtTime(0, s0.currentTime + i * .7);
    r.playbackRate.setValueAtTime(.035, s0.currentTime);
    r.playbackRate.setValueAtTime(.002, s0.currentTime + i);
    r.start(s0.currentTime);
    r.stop(s0.currentTime + i)
}
var i9 = "";
